...
//      //const response = await fetch('searchRouter.getStationName.useQuery');
//      const response = api.search.getStationName.useQuery();
...
const { data: cities, isLoading, error } = api.search.getStationName.useQuery();
          ...
          <div className="flex flex-col w-full">
            ...
            >
              ...
              {isLoading ? (
                ...
                cities?.map((city) => (
                  <option key={city.stop_id} value={city.stop_name}>{city.stop_name}</option>
                ))
              )}
            </select>
          </div>
